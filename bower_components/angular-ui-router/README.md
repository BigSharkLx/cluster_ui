...
-
**Note:** *UI-Router is under active development. As such, while this library is well-tested, the API may change. Consider using it in production app only if you're comfortable following a changelog and updating your usage accordingly.*
